      ...
      <ScrollView>
        <Card style={styles.container}>
          <View style={styles.subContainer}>
            ...
            <View>
              <Text style={{fontSize: 16}}>Mã Nhà: {this.state.product.prodId}</Text>
            </View>
            <View>
              <Text style={{fontSize: 16}}>Địa Chỉ: {this.state.product.prodName}</Text>
            </View>
            <View>
              <Text style={{fontSize: 16}}>Mô Tả: {this.state.product.prodDesc}</Text>
            </View>
            <View>
              <Text style={{fontSize: 16}}>Giá: {this.state.product.prodPrice}</Text>
            </View>
          </View>
